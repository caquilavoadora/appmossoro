...
if($sql)
{
$msg="Detalhes do médico atualizados com sucesso.";
...
<html lang="en">
	<head>
		<title>Admin | Editar Médico</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Editar Médico</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Altere aqui as informações do médico.</h5>
												</div>
...
<p><b>Criado em: </b><?php echo htmlentities($data['creationDate']);?></p>
<?php if($data['updationDate']){?>
<p><b>Atualizado em: </b><?php echo htmlentities($data['updationDate']);?></p>
<?php } ?>
<hr />
