				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Médico | Alterar Informações</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Médico</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Altere informações do médico aqui</h5>
												</div>
...
<p><b>Registrado em: </b><?php echo htmlentities($data['creationDate']);?></p>
<?php if($data['updationDate']){?>
<p><b>Última Atualização: </b><?php echo htmlentities($data['updationDate']);?></p>
<?php } ?>
<hr />
