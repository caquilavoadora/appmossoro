...
if($sql)
{
echo "<script>alert('Informações do paciente atualizadas com sucesso!');</script>";
...
<h5 class="panel-title">Altere as informações do paciente aqui</h5>
</div>
...
<div class="form-group">
              ...
              <input type="radio" name="gender" id="gender" value="Female" checked="true">Feminino
              ...
              <input type="radio" name="gender" id="gender" value="Female">Feminino
              </label>
             <?php } ?>
            </div>
<div class="form-group">
